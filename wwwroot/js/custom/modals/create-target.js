    ...
    var t, e, n, a, o, i; return {
        init: function ()
        {
            (i = document.querySelector("#kt_modal_new_target")) && (o = new bootstrap.Modal(i), a = document.querySelector("#kt_modal_new_target_form"), t = document.getElementById("kt_modal_new_target_submit"), e = document.getElementById("kt_modal_new_target_cancel"),
                $(a.querySelector('[name="batch_received_date"]')).flatpickr({ enableTime: 0, dateFormat: "d, M Y", maxDate: $("#RecDate").val() }),
                $(a.querySelector('[name="batch_date"]')).flatpickr({
                    enableTime: 0, dateFormat: "d, M Y", maxDate: $("#RecDate").val()
            ...
            n = FormValidation.formValidation(a, {
                fields: {
                    ...
                    batch_date: { validators: { notEmpty: { message: "Batch Date is required" } } },
                    batch_cost: { validators: { notEmpty: { message: "Total cost is required" } } }

                }, plugins: { trigger: new FormValidation.plugins.Trigger, bootstrap: new FormValidation.plugins.Bootstrap5({ rowSelector: ".fv-row", eleInvalidClass: "", eleValidClass: "" }) }
            }), t.addEventListener("click", (function (e) {
                e.preventDefault(), n && n.validate().then((function (e) {
                    console.log("validated y hassan 3!"), "Valid" == e ? (t.setAttribute("data-kt-indicator", "on"), a.submit(),
...
//        init: function () {
//        (i = document.querySelector("#kt_modal_new_target")) && (o = new bootstrap.Modal(i), a = document.querySelector("#kt_modal_new_target_form"), t = document.getElementById("kt_modal_new_target_submit"), e = document.getElementById("kt_modal_new_target_cancel"), new Tagify(a.querySelector('[name="tags"]'), { whitelist: ["Important", "Urgent", "High", "Medium", "Low"], maxTags: 5, dropdown: { maxItems: 10, enabled: 0, closeOnSelect: !1 } }).on("change",
//            (function () { n.revalidateField("tags") })), $(a.querySelector('[name="batch_received_date"]')).flatpickr({ enableTime: !0, dateFormat: "d, M Y, H:i" }),
//            $(a.querySelector('[name="batch_date"]')).flatpickr({ enableTime: 0, dateFormat: "d, M Y" }),
//            $(a.querySelector('[name="team_assign"]')).on("change", (function () { n.revalidateField("team_assign") })),
//            n = FormValidation.formValidation(a, {
//                fields: {
//                    target_title: { validators: { notEmpty: { message: "Target title is required" } } }, target_assign: { validators: { notEmpty: { message: "Target assign is required" } } },
//                    batch_vendor_id: { validators: { notEmpty: { message: "vendor Name  is required" } } }, batch_number: { validators: { notEmpty: { message: "Batch Number is required" } } },
